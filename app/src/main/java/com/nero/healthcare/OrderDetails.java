...
public class OrderDetails extends AppCompatActivity {
    ...
    private void initViews() {
        btnBack=(Button) findViewById(R.id.btnBackOrderDetails);
        listview=(ListView) findViewById(R.id.listViewOrderDetails);
        ...
        builder.setTitle("Delete Order")
                ...
                .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // Retrieve details of the selected order
                        ...
                        String fullname = selectedOrder.get("line1"); // Assuming line1 is fullname
                        String date ="Extract Date"; // Replace with actual data extraction logic
                        String time = "Extract Time";

                        // Delete the order from the database
                        Database db = new Database(getApplicationContext(), "healthcare", null, 1);
                        db.deleteOrder(username, fullname, date, time);
                        list.remove(position);
                        sa.notifyDataSetChanged();

                        Toast.makeText(OrderDetails.this, "Order deleted successfully", Toast.LENGTH_SHORT).show();
                    }
                })
